...
def main(client: ESMCInferenceClient):
    ...
    # ================================================================
    protein = ESMProtein(sequence="AAAAAAAA")
...
def raw_forward(model: ESMC):
    protein1= ESMProtein(sequence="AAAAA")
    protein2 = ESMProtein(sequence="AAAAAAAAAAAAAAAAAAAAA")
    assert protein1.sequence is not None
    sequences = [protein1.sequence, protein2.sequence]
    # ================================================================
